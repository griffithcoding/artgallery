/* =========================================================================
   ...
   plan swaps the seam implementation to Supabase without touching pages.
   ========================================================================= */
import type { Artist, Artwork, Exhibition, Fair, PressItem } from './gallery';
...
export function artSVG(seedKey: string, ratio: string): string {
...
/* ---- Build artworks (curated demo subset) ---- */
const DEMO_COUNT = 312;
...
for (let i = 0; i < DEMO_COUNT; i++) {
  ...
  const availTier = r();
  let availability: Artwork['availability'];
